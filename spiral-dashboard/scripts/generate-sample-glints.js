...
const glintStreamDir = path.join(process.cwd(), 'spiral/streams/patternweb');
if (!fs.existsSync(glintStreamDir)) {
  fs.mkdirSync(glintStreamDir, { recursive: true });
}

const glintStreamPath = path.join(glintStreamDir, 'glint_stream.jsonl');
